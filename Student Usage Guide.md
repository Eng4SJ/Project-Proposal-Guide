...
Engineering Senior Design courses are increasingly commonly including a client collaboration component that entails meeting with an industry contact about the project. The purpose of this involvement often entails aspects spanning gathering information and seeking feedback. Due to our projects’ different goal, while others have specific sponsor companies, we are working in service to an often loosely-affiliated-at-most community. In addition, while a company might have a designated contact point person assigned to interact with the student groups, any single contact person is antithetical to our goals due to the multifaceted nature of the project.
